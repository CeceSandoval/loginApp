...
interface NavbarPassengerProps {
  onProfileClick: () => void;
}
const NavbarPassenger: React.FC<NavbarPassengerProps> = ({ onProfileClick }) => {
  ...
  return (
    ...
    <nav className="flex items-center justify-between flex-wrap blue-900 p-6">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        ...
        <span className="font-semibold text-xl tracking-tight">GoTogether</span>
      </div>
      ...
      <button
          ...
          onClick={onProfileClick} disabled={isLoading}>
          Perfil
        </button>
        </div>
        <div>
